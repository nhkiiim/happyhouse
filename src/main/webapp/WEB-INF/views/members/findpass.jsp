<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="modal fade in" id="findModal" role="dialog"
	aria-hidden="true">
	<!-- <script>
		$(function() {
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content rounded-lg">
			...
			<!-- <div class="modal-body">
				<div class="container">
					<form action="find" method="post" id="findform">
						<div class="form-group mt-2 mb-2">
							<div class="row mb-3">
								<label class="col-md-3" for="jid">아이디 *</label> <input
									class="col-md-9 form-control" id="userid" name="id" type="text"
									required>
							</div>
							<div class="row mb-3">
			...
			<!-- <div class="modal-footer">
				<div class="container d-flex justify-content-center">
					<button id="findbutton" type="submit"
						class="btn btn-success mr-2 col-3">찾기</button>
				</div>
			</div> -->
